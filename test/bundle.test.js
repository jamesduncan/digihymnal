...
/* harmony import */ var _src_data_song__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var chai__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
...
const TARGET = new _src_data_song__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
describe('Song Data', async () => {
    describe('list()', async () => {
        it('should return an array list of Songs', async () => {
            ...
            chai__WEBPACK_IMPORTED_MODULE_1__["assert"].isArray(result);
        });
    });
    ...
    describe('get()', async () => {
        it('should return a song that id is "sample01"', async () => {
            ...
            chai__WEBPACK_IMPORTED_MODULE_1__["assert"].exists(result);
            chai__WEBPACK_IMPORTED_MODULE_1__["assert"].equal(id, result.id);
        });
    });
    ...
    describe('languages()', async () => {
        it('should return a available language code list of the song', async () => {
            ...
            chai__WEBPACK_IMPORTED_MODULE_1__["assert"].exists(result);
            chai__WEBPACK_IMPORTED_MODULE_1__["assert"].isArray(result);
            chai__WEBPACK_IMPORTED_MODULE_1__["assert"].equal("eng", result[0]);
            chai__WEBPACK_IMPORTED_MODULE_1__["assert"].equal("at", result[1]);
            chai__WEBPACK_IMPORTED_MODULE_1__["assert"].equal("ct", result[2]);
            chai__WEBPACK_IMPORTED_MODULE_1__["assert"].equal("ctr", result[3]);
        });
    });
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SongCollection; });
/* harmony import */ var _samples_1_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _samples_2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);



const SAMPLE_SONGS = [_samples_1_js__WEBPACK_IMPORTED_MODULE_0__["default"], _samples_2_js__WEBPACK_IMPORTED_MODULE_1__["default"]];
...
var pathval = __webpack_require__(8);
...
exports.compareByInspect = __webpack_require__(33);

/*!
 * Get own enumerable property symbols method
 */

exports.getOwnEnumerablePropertySymbols = __webpack_require__(34);
...
exports.isProxyEnabled = __webpack_require__(25);
...
var flag = __webpack_require__(10);
var isProxyEnabled = __webpack_require__(25);
...
var getOwnEnumerablePropertySymbols = __webpack_require__(34);
